...
@section('content')
                ...
                <div class="swiper home_swiper">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="img_wrap">
                                <img width="2560" height="1235" src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%202560%201235'%3E%3C/svg%3E" class="" alt="" decoding="async" data-lazy-src="{{ $product->image }}" />
                                <noscript>
                                    <img width="2560" height="1235" src="{{ $product->image }}" class="" alt="" decoding="async" />
                                </noscript>
                            </div>
                            <a class="wrap_link" href="/product/{{ $product->slug }}" title="{{ mb_strtoupper($product->name, 'UTF-8') }}">{{ mb_strtoupper($product->name, 'UTF-8') }}</a>
                            <a href="/product/{{ $product->slug }}" class="flex_box al_center">
                                <div class="plus_btn">
                                ...
                                <h3 class="m_0 text_white font_oswald fw300">{{ mb_strtoupper($product->name, 'UTF-8') }}</h3>
                            </a>
                        </div>
                        @endforeach
                    </div>
                        ...
                        <div class="col_7 tablet_col_12" data-aos="fade-left" data-aos-delay="300" data-aos-duration="500">
                            <div class="terms_menu">
                                <ul class="ls_none m_0 flex_box al_center jus_end tablet_jus_center">
                                    <li>
                                        <a class="flex_box al_center" href="/categories">
                                    ...
                                    <li>
                                        <a class="flex_box al_center" href="/categories/{{ $category->slug }}">
                                            <svg width="0" height="1" viewBox="0 0 35 1" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <line x1="35" y1="0.5" x2="-4.37114e-08" y2="0.499997" stroke="#FFF"></line>
                                            </svg>
            ...
            <section class="section home_2">
                <div data-bg="{{ $products[0]->image }}" class="box_project_home bg_cus rocket-lazyload" data-aos="fade-up" data-aos-delay="300" data-aos-duration="500">
                    <div class="grid_box grid_3 mobile_grid_2">
                        @foreach($products as $product)
                        <div data-bg="{{ $product->image }}" class="item relative bg_cus rocket-lazyload" data-image="{{ $product->image }}">
                            <a href="/product/{{ $product->slug }}" class="wrap_link"></a>
                            <h3 class="fs_25 lh_28 fw300 text_white font_oswald text_uppercase">{{ mb_strtoupper($product->name, 'UTF-8') }}</h3>
                        </div>
                        @endforeach
                    </div>
                </div>
                ...
                <div class="grid-container">
                        ...
                        <div class="col_7 tablet_col_12" data-aos="fade-left" data-aos-delay="300" data-aos-duration="500">
                            <div class="terms_menu">
                                <ul class="ls_none m_0 flex_box al_center jus_end tablet_jus_center">
                                    ...
                                    <li>
                                        <a class="flex_box al_center" href="/topics/{{ $topic->slug }}">
                                            <svg width="0" height="1" viewBox="0 0 35 1" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <line x1="35" y1="0.5" x2="-4.37114e-08" y2="0.499997" stroke="#FFF"></line>
                                            </svg>
                    ...
                    <div class="grid_box grid_3 mobile_grid_1">
                        ...
                        <div class="post_item relative hover_zoom_img" data-aos="fade-up" data-aos-delay="300" data-aos-duration="500">
                            <a href="/post/{{ $post->slug }}" class="wrap_link"></a>
                            <div class="img_wrap">
                            ...
                            <div class="cont_wrap">
                                <div class="date_cat flex_box al_center">
                                    <a href="/category/{{ $post->topic->slug }}">{{ $post->topic->name }}</a>
