...
<section class="section project_page_1">
    <div class="grid-container">
        <h1 class="sec_title_2">Dịch vụ tại VDesignAds</h1>
    </div>
</section>
        ...
        <div class="projects_filters">
            <div class="flex_box al_center">
                <div class="filter_group relative">
                    ...
                    <input type="text" name="search_project" id="search_project" placeholder="Tìm kiếm dịch vụ">
                </div>
                <div class="filter_group relative">
            ...
            <div class="grid_box grid_3 mobile_grid_2" id="project_list">
                ...
                <div class="project_item relative hover_zoom_img">
                    ...
                    <div class="cont_wrap absolute ts_04">
                        <h3 class="limit_line limit_1 fs_18 lh_28 fw300 text_white font_oswald m_0">{{ mb_strtoupper($service->name, 'UTF-8') }}</h3>
                    </div>
                </div>
                @endforeach
            </div>
