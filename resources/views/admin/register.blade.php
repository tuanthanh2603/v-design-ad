...
<head>
    ...
    <title>Tạo tài khoản - V Design</title>
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                            <div class="card card-plain mt-2">
                                ...
                                <div class="card-header pb-0 bg-transparent title-center">
                                    <h3 class="font-weight-bolder text-info text-gradient">Tạo tài khoản</h3>
                                ...
                                <div class="card-body">
                                    <form method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="text-center">
                                            <button type="submit" class="btn bg-gradient-info w-100 mt-4 mb-0">Tạo tài khoản</button>
                                        </div>
                                    </form>
                                </div>
