    ...
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            @if (request()->is('admin/dashboard'))
                <h6 class="font-weight-bolder mb-0 mt-2">Dashboard</h6>
            @elseif(request()->is('admin/khach-hang'))
                <h6 class="font-weight-bolder mb-0 mt-2">Khách hàng</h6>
            @elseif(request()->is('admin/dich-vu'))
                <h6 class="font-weight-bolder mb-0 mt-2">Dịch vụ</h6>
            @elseif(request()->is('admin/san-pham'))
            ...
            @elseif(request()->is('admin/tin-tuc'))
                <h6 class="font-weight-bolder mb-0 mt-2">Tin tức</h6>
            @endif
        </nav>
